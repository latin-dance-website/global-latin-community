...
export default function EventInfo({ setIsToastVisible }) {
      ...
      about: () => (
        <Box>
          ...
          <Text
            ...
            marginBottom={"0.5rem"}
          >
            Get ready for the next edition of our Bachata Intensive! This time,
            we’re bringing the incredible Amanda Rishabh from Mumbai to level
            for a transformative weekend with Amanda @manda_tong & Rishabh
            @rishabhd05 - Indian J&J Champions on some of the biggest stages in
            the country! 🏆💃🕺
          </Text>
          <Text
            fontSize="1rem"
            ...
            marginBottom={"0.5rem"}
          >
            After training under @amargueflowdanceacademy to strengthen their
            foundation in traditional bachata they expanded this knowledge to
            modern, sensual and fusion bachata. Now, they bring their expertise
            to Bangalore for an exclusive Partnerwork Intensive at Dhurii Domlur
            on March 21st-23rd, 2025!
          </Text>
          <Text
            fontSize="1.2rem"
            fontFamily={"montserrat"}
...

    {
      ...
      <Text fontSize="1rem" fontFamily="montserrat" mb="0.5rem">
        ...
        amazing choreo and some partner-work.
          ...
          >
            {" "}
            Day 1- History, Culture & Music{" "}
          </Text>
          <Text fontSize="0.8rem" fontFamily={"montserrat"}>
            - Discover the roots of Bachata in the Dominican Republic
          </Text>
          <Text fontSize="0.8rem" fontFamily={"montserrat"}>
            {" "}
            - Dive into its cultural evolution and significance
          </Text>
          <Text fontSize="0.8rem" fontFamily={"montserrat"}>
            {" "}
            - Train your ear to identify Bachata rhythms and deepen your musical
            connection
          </Text>
          ...
          >
            {" "}
            - Learn the instruments that shape Bachata: requinto (lead guitar),
            segunda (rhythm guitar), bass, bongos, and guira
          </Text>
          <Text
            fontSize="1rem"
            fontFamily={"montserrat"}
            marginBottom={"0.2rem"}
          >
            Day 2-Musicality, Movement & Partnerwork{" "}
          </Text>
         

          <Text fontSize="0.8rem" fontFamily={"montserrat"}>
          - Freestyling insights to help you unlock your own dance voice
          </Text>
          <Text fontSize="0.8rem" fontFamily={"montserrat"}>
            {" "}
           -  Learn how to apply musicality in both solo and partner dancing 
          </Text>

          <Text fontSize="0.8rem" fontFamily={"montserrat"}>
            {" "}
            -  Explore body movement and styling with fluidity and control
          </Text>
          <Text fontSize="0.8rem" fontFamily={"montserrat"}    marginBottom={"0.5rem"}>
            {" "}
            - Dive into interactive partnerwork sessions to build connection and rhythm
          </Text>
          ...
          <Text
            ...
            marginBottom={"0.2rem"}
          >
            Day 3 – Choreo Jam & Celebration
          </Text>
          
          <Text fontSize="0.8rem" fontFamily={"montserrat"}> - Time to put it all together in a fun and fiery Bachata
          choreography</Text>
          <Text fontSize="0.8rem" fontFamily={"montserrat"} > - Apply everything you’ve learned so far—musicality,
          movement, partnerwork</Text>
          <Text fontSize="0.8rem" fontFamily={"montserrat"} marginBottom={"0.5rem"}> - A celebration of learning,
          expression, and community</Text>
          ...
          <Text fontSize="1rem" fontFamily={"montserrat"} color="blue.300">
            #BachataPartnerwork #RootedinCulture #AmanAndMegha #BachataWorkshop
            #RefinedinMovement. #bachataintensive
          </Text>
        </Box>
      ),
      terms: ["The ticket is non - refundable"],
      ...
      iframeLink:
        "https://www.google.com/maps?q=The+Stardom+Studio,+Sanghvi+Nagar,+Pune&output=embed",
    },
  ];
          ...
          "https://s356o5gg2kfik723dpxbqrb2da0wahnn.lambda-url.ap-south-1.on.aws/",
          {
            ...
            body: JSON.stringify({
              metadata: {
                ...
                event: "emailUpload",
                purpose: "paymentSuccessfulEmail",
  ...
  return (
    <Box
      ...
      paddingY="20px"
      paddingX={{ lg: "10rem", base: "20px" }}
    >
      {isEventLoading ? (
        <Spinner size="xl" thickness="4px" speed="0.65s" color="gray.400" />
      ) : (
        <>
          {events
            ...
            .map((event) => {
              return (
                <>
                  <Image
                    src={`/assets/images/eventImages/${event.id}.jpg`}
                    width="100%"
                    height="auto"
                    borderRadius={"15px"}
                  ></Image>
                  ...
                  >
                    ...
                    {isBookNowClicked ? (
                            ...
                            {event.tickets.map((ticketObject, index) => {
                              return (
                                ...
                                >
                                  ...
                                  >
                                    {" "}
                                    {ticketObject.name} (₹ {ticketObject.amount}
                                    )
                                  </Box>
                                  <Button
                                    bg="#ff7c19"
                      ...
                      <Button
                        ...
                        color="white"
                        fontSize="1rem"
                        onClick={() => setIsBookNowClicked(true)}
                        marginBottom={{ base: "1rem", md: "" }}
                      >
                        Book Now!
                      </Button>
                    )}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <Link href={event.googleMapsLink} isExternal>
                          <Text cursor="pointer">View In Google Maps</Text>
                        </Link>
                        <Box mt={2}>
                          <iframe
