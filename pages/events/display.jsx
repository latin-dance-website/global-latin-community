...
export default function EventsDisplayPage({ allEvents }) {
                  ...
                  >
                    ...
                    >
                      ...
                      <Box
                        ...
                        _hover={{
                          bgGradient:
                            "linear(135deg, #6B46C1 0%, #B83280 100%)", // Darker gradient on hover
  ...
  <Flex align="center" gap={2}>
    ...
    <Text
      ...
      sx={{ 
        fontFamily: "inherit",
        marginTop: "-1px", // Slight upward adjustment
        display: "flex",
        alignItems: "center"
      }}
    >
  ...
  <Flex align="center" gap={2}>
    ...
    >
      {event.musicRatio || "Mixed"}
                         ...
                         {/* Location */}
<Flex align="center" gap={2} ml={-1} mb={-2}>
  <Box color="#805AD5" fontSize="14px" display="flex" alignItems="center">
    <FaLocationDot />
  </Box>
  <Text
    fontSize="13px"
                  ...
                  >
                    ...
                    <Box textAlign="center">
                      ...
                      <Button
                        ...
                        _hover={{
                          bgGradient:
                            "linear(135deg, #6B46C1 0%, #B83280 100%)",
                          transform: "translateY(-2px)",
